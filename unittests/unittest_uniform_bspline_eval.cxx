...
TEST(BSpline, UniformBSpline_eval_parDim1_geoDim1_degrees1_double)
{
  ...
  iganet::UniformBSpline<double, 1, 1> bspline({11}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 2> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim1_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-12); 
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 3> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim1_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-12);  
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 4> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim1_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 5> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim1_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10); 
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 6> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim1_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10); 
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 1> bspline({11}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 2> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim2_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-12);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 3> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim2_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-12);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 4> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim2_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 5> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim2_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 6> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim2_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 1> bspline({11}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 2> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim3_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-12);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 3> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim3_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-12);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 4> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim3_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 5> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim3_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 6> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim3_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 1> bspline({11}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 2> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim4_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-12);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 3> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim4_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-12);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 4> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim4_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 5> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim4_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 6> bspline({11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim1_geoDim4_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
}
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 2, 2> bspline({6, 5}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 4, 6> bspline({5, 11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim2_geoDim1_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 6, 4> bspline({11, 5}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim2_geoDim1_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 2, 2> bspline({6, 5}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 4, 6> bspline({5, 11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim2_geoDim2_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 6, 4> bspline({11, 5}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim2_geoDim2_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 2, 2> bspline({6, 5}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 4, 6> bspline({5, 11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim2_geoDim3_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 6, 4> bspline({11, 5}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim2_geoDim3_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 2, 2> bspline({6, 5}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 4, 6> bspline({5, 11}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim2_geoDim4_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 6, 4> bspline({11, 5}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim2_geoDim4_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
  test_bspline_eval(bspline, xi, 1e-10);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 2, 2, 2> bspline({11, 5, 3}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 2, 6, 4> bspline({3, 11, 5}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim3_geoDim1_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 2, 2, 2> bspline({11, 5, 3}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 2, 6, 4> bspline({3, 11, 5}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim3_geoDim2_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 2, 2, 2> bspline({11, 5, 3}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 2, 6, 4> bspline({3, 11, 5}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim3_geoDim3_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 2, 2, 2> bspline({11, 5, 3}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 2, 6, 4> bspline({3, 11, 5}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim3_geoDim4_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0}, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 2, 2, 2, 2> bspline({11, 5, 3, 8}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 1, 2, 6, 4, 3> bspline({3, 11, 5, 8}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim4_geoDim1_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 2, 2, 2, 2> bspline({11, 5, 3, 8}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 2, 2, 6, 4, 3> bspline({3, 11, 5, 8}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim4_geoDim2_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 2, 2, 2, 2> bspline({11, 5, 3, 8}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 3, 2, 6, 4, 3> bspline({3, 11, 5, 8}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim4_geoDim3_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 2, 2, 2, 2> bspline({11, 5, 3, 8}, iganet::init::zeros, options);
...
{
  iganet::Options<double> options;
  iganet::UniformBSpline<double, 4, 2, 6, 4, 3> bspline({3, 11, 5, 8}, iganet::init::zeros, options);
  bspline.transform(trafo_parDim4_geoDim4_double);
  auto xi  = iganet::utils::to_tensorArray<double>({0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
                                                   {0.0, 0.1, 0.2, 0.5, 0.75, 0.9, 1.0},
