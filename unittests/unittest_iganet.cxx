...
TEST(BSpline, IgANet_UniformBSpline_2d) {
  ...
  EXPECT_EQ(net.variable().boundary().side<iganet::side::south>().ncoeffs(0),
            4);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::north>().ncoeffs(0),
            4);
}
...
TEST(BSpline, IgANet_UniformBSpline_3d) {
  ...
  EXPECT_EQ(net.variable().boundary().side<iganet::side::north>().ncoeffs(0),
            4);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::front>().ncoeffs(0),
            4);
  ...
  EXPECT_EQ(net.variable().boundary().side<iganet::side::south>().ncoeffs(1),
            3);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::north>().ncoeffs(1),
            3);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::front>().ncoeffs(1),
            6);
...
TEST(BSpline, IgANet_UniformBSpline_4d) {
  ...
  EXPECT_EQ(net.variable().boundary().side<iganet::side::front>().ncoeffs(0),
            4);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::back>().ncoeffs(0), 4);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::stime>().ncoeffs(0),
            4);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::etime>().ncoeffs(0),
            4);
  ...
  EXPECT_EQ(net.variable().boundary().side<iganet::side::front>().ncoeffs(1),
            6);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::back>().ncoeffs(1), 6);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::stime>().ncoeffs(1),
            6);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::etime>().ncoeffs(1),
            6);
  ...
  EXPECT_EQ(net.variable().boundary().side<iganet::side::south>().ncoeffs(2),
            5);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::north>().ncoeffs(2),
            5);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::front>().ncoeffs(2),
            5);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::back>().ncoeffs(2), 5);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::stime>().ncoeffs(2),
            3);
  EXPECT_EQ(net.variable().boundary().side<iganet::side::etime>().ncoeffs(2),
            3);
}
