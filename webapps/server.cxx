...
int main(int argc, char const* argv[])
{
  ...
  auto modelpath_option = op.add<popl::Value<std::string>>("m", "modelpath", "path to model files", "");
          ...
          try {
            ...
            if (tokens[0] == "get") {
              ...
              try {
                ...
                response["reason"] = "Invalid GET request. Valid GET requests are \"get\", \"get/<session-id>\", \"get/<session-id>/<model-instance>\", and \"get/<session-id>/<model-instance>/<model-component>\", and \"get/<session-id>/<model-instance>/<model-component>/<attribute>\"";
                ws->send(response.dump(), uWS::OpCode::TEXT, true);
              }
              ...
              try {
                ...
                response["reason"] = "Invalid PUT request. Valid PUT requests are \"put/<session-id>/<model-instance>/<attribute>\", and \"put/<session-id>/<model-instance>/<model-component>/<attribute>\"";
                ws->send(response.dump(), uWS::OpCode::TEXT, true);
              }
              ...
              try {
                ...
                response["reason"] = "Invalid CREATE request. Valid CREATE requests are \"create/session\" and \"create/<session-id>/<model-type>\"";
                ws->send(response.dump(), uWS::OpCode::TEXT, true);
              }
              ...
              try {
                ...
                response["reason"] = "Invalid CONNECT request. Valid CONNECT requests are \"connect/<session-id>\"";
                ws->send(response.dump(), uWS::OpCode::TEXT, true);
              }
              ...
              try {
                ...
                response["status"] = iganet::webapp::status::invalidEvalRequest;
                response["reason"] = "Invalid EVAL request. Valid EVAL requests are \"eval/<session-id>/<model-instance>\"";
                ws->send(response.dump(), uWS::OpCode::TEXT, true);
              }
              ...
              try {
                ...
                response["reason"] = "Invalid LOAD request. Valid LOAD requests are \"load/session\" and \"load/<session-id>\"";
                ws->send(response.dump(), uWS::OpCode::TEXT, true);
              }
              ...
              try {
                ...
                if (tokens.size() == 2) {
                  ...
                  if (auto m = std::dynamic_pointer_cast<iganet::ModelSerialize>(model))
                    ...
                    response["reason"] = "Invalid save request. Valid requests are \"save/<session-id>\" and \"save/<session-id>/<model-instance>\"";
                  }
                  ws->send(response.dump(), uWS::OpCode::TEXT, true);                
                }
              ...
              try {
                ...
                if (tokens.size() == 2) {
                  ...
                  if (auto m = std::dynamic_pointer_cast<iganet::ModelXML>(model))
                    ...
                    response["status"] = iganet::webapp::status::invalidImportRequest;
                    response["reason"] = "Invalid import request. Valid requests are \"importxml/<session-id>\", \"importxml/<session-id>/<model-instance>\" and \"importxml/<session-id>/<model-instance>/<model-component>\"";
                  }
                  ws->send(response.dump(), uWS::OpCode::TEXT, true);
                ...
                response["status"] = iganet::webapp::status::invalidImportRequest;
                response["reason"] = "Invalid IMPORTXML request. Valid IMPORTXML requests are \"importxml/<session-id>\", \"importxml/<session-id>/<model-instance>\" and \"importxml/<session-id>/<model-instance>/<model-component>\"";
                ws->send(response.dump(), uWS::OpCode::TEXT, true);
              }
              ...
              try {
                ...
                response["reason"] = "Invalid EXPORTXML request. Valid EXPORTXML requests are \"exportxml/<session-id>\", \"exportxml/<session-id>/<model-instance>\" and and \"exportxml/<session-id>/<model-instance>/<model-component>\"";
                ws->send(response.dump(), uWS::OpCode::TEXT, true);
              }
              ...
              try {
                ...
                response["status"] = iganet::webapp::status::invalidRefineRequest;
                response["reason"] = "Invalid REFINE request. Valid REFINE requests are \"refine/<session-id>/<model-instance>\"";
                ws->send(response.dump(), uWS::OpCode::TEXT, true);
              }
