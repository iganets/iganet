...
#include <iganet/net/generator.hpp>
#include <iganet/net/collocation.hpp>
#include <iganet/net/optimizer.hpp>
...
#include <iganet/utils/tuple.hpp>
#include <iganet/utils/zip.hpp>
