...
namespace iganet {
  ...
  /// @{
  template<typename T>
  inline constexpr c10::ScalarType dtype() { return caffe2::TypeMeta::Make<T>().toScalarType(); }

  template<>
  inline constexpr c10::ScalarType dtype<half>() { return torch::kHalf; }
  
  template<>
  inline constexpr c10::ScalarType dtype<long>() { return torch::kLong; }

  template<>
  inline constexpr c10::ScalarType dtype<char>() { return torch::kChar; }

  template<>
  inline constexpr c10::ScalarType dtype<std::complex<double>>() { return at::kComplexDouble; }

  template<>
  inline constexpr c10::ScalarType dtype<std::complex<float>>() { return at::kComplexFloat; }

  template<>
  inline constexpr c10::ScalarType dtype<std::complex<half>>() { return at::kComplexHalf; }
  /// @}
  ...
  public:
    ...
    /// @brief Returns a new Options object with the `device_index` property as given
