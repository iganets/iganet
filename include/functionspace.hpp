...
namespace iganet {
  ...
  class FunctionSpace : public std::tuple<FunctionSpace<spline_t>...>
  {
  protected:
    /// @brief Base class
    using Base = std::tuple<FunctionSpace<spline_t>...>;
  ...
  public:   
    ...
    FunctionSpace(enum init init,
                  const std::array<int64_t, spline_t::parDim()>&... ncoeffs)
      : Base({init, ncoeffs}...),
    ...
    FunctionSpace(enum init init,
                  const std::array<std::vector<typename spline_t::value_type>,
                  spline_t::parDim()>&... kv)
      : Base({init, kv}...),
        boundary_({kv, init}...)
    {}
  ...
  public:
    ...
    /// @brief Constructor
    FunctionSpace(enum init init,
                  std::array<std::vector<typename spline_t::value_type>,
                  spline_t::parDim()> kv)
      : spline_t(kv, init),
        boundary_(kv, init)
    {
  ...
  template<typename spline_t>
  class TH1 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1>,
  ...
  /// S_{p,p}^{p-1,p-1} \f$
  template<typename spline_t>
  class TH2 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1,
                                                       spline_t::degree(1)+1>,
  ...
  template<typename spline_t>
  class TH3 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1,
                                                       spline_t::degree(1)+1,
  ...
  template<typename spline_t>
  class TH4 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1,
                                                       spline_t::degree(1)+1,
  ...
  /// \f$ S_{p+1}^{p-1} \otimes S_{p}^{p-1} \f$
  template<typename spline_t>
  class NE1 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1>,
                                   typename spline_t::template
  ...
  /// S_{p,p}^{p-1,p-1} \f$
  template<typename spline_t>
  class NE2 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1,
                                                       spline_t::degree(1)+1>,
  ...
  /// S_{p,p,p}^{p-1,p-1,p-1} \f$
  template<typename spline_t>
  class NE3 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1,
                                                       spline_t::degree(1)+1,
  ...
  /// S_{p,p,p,p}^{p-1,p-1,p-1,p-1} \f$
  template<typename spline_t>
  class NE4 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1,
                                                       spline_t::degree(1)+1,
  ...
  /// \f$ S_{p+1}^{p-1} \otimes S_{p}^{p-1} \f$
  template<typename spline_t>
  class RT1 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1>,
                                   typename spline_t::template
  ...
  /// S_{p,p}^{p-1,p-1} \f$
  template<typename spline_t>
  class RT2 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1,
                                                       spline_t::degree(1)>,
  ...
  /// S_{p,p,p}^{p-1,p-1,p-1} \f$
  template<typename spline_t>
  class RT3 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1,
                                                       spline_t::degree(1),
  ...
  /// S_{p,p,p,p}^{p-1,p-1,p-1,p-1} \f$
  template<typename spline_t>
  class RT4 : public FunctionSpace<typename spline_t::template
                                   derived_self_type_t<typename spline_t::value_type,
                                                       spline_t::geoDim(),
                                                       spline_t::degree(0)+1,
                                                       spline_t::degree(1),
